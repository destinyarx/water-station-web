...
export function DocumentsPage() {
  ...
  const stats = useMemo(() => {
    ...
    const privateCount = docs.filter((d) => d.visibility === 'only_me').length
    const sharedCount = docs.filter((d) => d.visibility === 'all').length
  ...
  const filtered = useMemo(() => {
    ...
    if (visFilter === 'mine') docs = docs.filter((d) => d.createdBy === userId)
    if (visFilter === 'private') docs = docs.filter((d) => d.visibility === 'only_me' && d.createdBy === userId)
    if (search.trim()) {
    ...
    return docs
  }, [documents, catFilter, visFilter, search, userId])
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-8">
        ...
        <div className="grid gap-4 mb-7" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))' }}>
          ...
          <StatChip
            ...
            accentColor="var(--app-chip-amber-text)"
            icon={
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <StatChip
            ...
            accentColor="var(--app-chip-green-text)"
            icon={
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
